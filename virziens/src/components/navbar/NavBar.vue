...
<template>
    ...
    <div v-if="!mobileView" class=" flex justify-end ">
        <nav class="w-2/3 flex justify-end flex-wrap  gap-3 ">
            <div  class="bg-black   rounded-sm font-extrabold text-white px-2 cursor-pointer hover:underline">
                <span>SĀKUMS</span>
            </div>
              <div  class="bg-black  rounded-sm font-extrabold text-white px-2 cursor-pointer hover:underline">
                <span>PAR MUMS</span>
...
<div :class="menuClass" class="transition-transform duration-500  flex flex-col w-9/10 h-screen bg-black  pt-6">
